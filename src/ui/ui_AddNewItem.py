...
################################################################################
## Form generated from reading UI file 'AddNewItemdhteTY.ui'
##
...
class Ui_AddNewItem(object):
    def setupUi(self, AddNewItem):
        if not AddNewItem.objectName():
            AddNewItem.setObjectName(u"AddNewItem")
        AddNewItem.resize(305, 450)
        self.verticalLayout_3 = QVBoxLayout(AddNewItem)
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.frame = QFrame(AddNewItem)
        ...
        self.label_2.setGeometry(QRect(0, 10, 171, 31))
        font = QFont()
...
"}")
        ...
        self.Qty = QLineEdit(self.frame_7)
        self.Qty.setObjectName(u"Qty")
        self.Qty.setGeometry(QRect(120, 10, 161, 21))
        self.Qty.setFont(font2)
        ...
        self.catergory = QLineEdit(self.frame_5)
        self.catergory.setObjectName(u"catergory")
        self.catergory.setGeometry(QRect(120, 10, 161, 21))
        self.catergory.setFont(font2)
        ...
        self.barCode = QLineEdit(self.frame_6)
        self.barCode.setObjectName(u"barCode")
        self.barCode.setGeometry(QRect(120, 10, 161, 21))
        self.barCode.setFont(font2)
...
"}")
        ...
        self.retranslateUi(AddNewItem)

        QMetaObject.connectSlotsByName(AddNewItem)
    # setupUi

    def retranslateUi(self, AddNewItem):
        AddNewItem.setWindowTitle(QCoreApplication.translate("AddNewItem", u"Dialog", None))
        self.label_2.setText(QCoreApplication.translate("AddNewItem", u"Add New Item", None))
        self.label_3.setText(QCoreApplication.translate("AddNewItem", u"Set Item ID", None))
        self.itemID.setText("")
        self.label_6.setText(QCoreApplication.translate("AddNewItem", u"Set Name", None))
        self.label_4.setText(QCoreApplication.translate("AddNewItem", u"Normal Price", None))
        self.label_9.setText(QCoreApplication.translate("AddNewItem", u"First Qty.", None))
        self.label_5.setText(QCoreApplication.translate("AddNewItem", u"Category", None))
        self.label_7.setText(QCoreApplication.translate("AddNewItem", u"BarCode", None))
        self.btnCancelAddToStore.setText(QCoreApplication.translate("AddNewItem", u"Cancel", None))
        self.OK.setText(QCoreApplication.translate("AddNewItem", u"OK", None))
    # retranslateUi
